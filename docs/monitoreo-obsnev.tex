...
\href{https://ee-ugr-default-project.projects.earthengine.app/view/biorefuges}{MonitorEO-OBSNEV Bio-Refugios} es una herramienta de análisis de variables derivadas de teledetección satelital basada en Google Earth Engine desarrollada por el Observatorio de Cambio Global de Sierra Nevada (Universidad de Granada).
...
\section{\texorpdfstring{🌱 \textbf{Bio-Refugios}}{🌱 Bio-Refugios}}\label{bio-refugios}
